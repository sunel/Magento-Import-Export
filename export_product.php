<?php
	    ...
	    protected function _prepareEntityCollection(Mage_Eav_Model_Entity_Collection_Abstract $collection)
	    {
	        ...
	        foreach ($this->filterAttributeCollection($this->getAttributeCollection()) as $attribute) {
	            ...
	            if (isset($exportFilter[$attrCode])) {
					...
					} else if (Mage_ImportExport_Model_Export::FILTER_TYPE_SELECT == $attrFilterType) {
	...
	class ProductExporter {
		...
		public function runMain($exportProducts=array())
		{
			...
			$n->export(MAGENTO.'/var/product.csv');
			echo MAGENTO."/var/product.csv \n\n";
		}
